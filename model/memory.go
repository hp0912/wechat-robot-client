...
type Memory struct {
	...
	ContactWxID  string     `gorm:"column:contact_wxid;index;index:idx_contact_key;index:idx_contact_type" json:"contact_wxid"`
	ChatRoomID   string     `gorm:"column:chat_room_id;index" json:"chat_room_id"`
	Type         MemoryType `gorm:"column:type;size:32;index;index:idx_contact_type" json:"type"`
	Key          string     `gorm:"column:key;size:255;index:idx_contact_key" json:"key"`
	...
	LastAccessAt int64      `gorm:"column:last_access_at;index" json:"last_access_at"`
