...
type MomentSettings struct {
	...
	SyncKey             string  `gorm:"type:text;not null;default:'';comment:朋友圈同步的key" json:"sync_key"`
	...
	CommentPrompt       string  `gorm:"type:text;not null;default:'';comment:评论系统提示词" json:"comment_prompt"`
